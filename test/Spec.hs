...
-}
  ...
  describe "Day22" $ do
    ...
    it "Part 1" $ do
      file <- readFile (path ++ "22.txt")
      (Day22.parse >>> Day22.calc1 >>> show) file `shouldBe` "306"

    {-
    it "Part 2" $ do
      file <- readFile (path ++ "22.txt")
      (Day22.parse >>> Day22.calc2 >>> show) file `shouldBe` "273"
    -}
  ...
  describe "Day25" $ do
    ...
    it "Part 1" $ do
      file <- readFile (path ++ "25.txt")
      (Day25.parse >>> Day25.calc1 >>> show) file `shouldBe` "14897079"
